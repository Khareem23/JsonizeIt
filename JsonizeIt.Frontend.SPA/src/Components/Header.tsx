const Nav = () => {
  return (
    <div className="flex items-center justify-between w-[80%] mx-auto my-0 font-inter">
      ...
      <p className="font-medium text-[12px] md:text-[14px] leading-[100%]">How it Works</p>
    </div>
  )
}
...
const Header = () => {
  return (
    <div className="font-inter flex flex-col items-center gap-10 text-white bg-[#001941] pt-3 min-h-[33vh]">
      <Nav />
